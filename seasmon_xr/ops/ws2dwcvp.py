...
def ws2dwcvp(y, nodata, p, llas, robust, out, lopt):
    ...
    asymmetric weights. (Garcia, Robust smoothing of gridded data in one and higher dimensions with
    missing values: https://doi.org/10.1016/j.csda.2009.09.020 ; Eilers, Pesendorfer and Bonifacio,
    Automatic smoothing of remote sensing data, https://doi.org/10.1016/j.csda.2009.09.020)
